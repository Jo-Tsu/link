...
from smallink.connectors.tool_defs import mcp_pinned_tools, mcp_tool_defs, tool_dicts
from smallink.mcp.config import put_global_server, read_global
...
def test_stale_token_reauth_never_opens_a_browser_mid_turn(tmp_path, monkeypatch):
    ...
    from smallink.mcp import oauth as mcp_oauth
