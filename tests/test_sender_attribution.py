...
channels shared by several Link users can tell whose agent is speaking.
...
from smallink.connectors import attribution
from smallink.connectors.base import SendResult
from smallink.connectors.setup import managed_connect_slack_install
