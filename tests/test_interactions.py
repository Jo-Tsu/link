...
from smallink.interactions import Button, buttons_for, decode, encode
from smallink.connectors.base import InteractionEvent
from smallink.connectors.senders import _slack_blocks
...
def test_slack_blocks_shape():
    ...
    assert [e["action_id"] for e in els] == ["link_0", "link_1"]
