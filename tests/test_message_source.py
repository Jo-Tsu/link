...
from smallink.connectors.base import MessageEvent, MessageSource, SessionSource
...
def test_message_source_persisted_and_stripped(tmp_path):
    ...
    assert last_user["source"]["channel_name"] == "#link-test"
...
def test_tool_display_sidecar_is_agent_invisible(tmp_path):
    ...
    from smallink.providers.base import ToolCall
...
def test_turn_start_carries_source(tmp_path):
    ...
    assert source["channel_name"] == "#link-test"
