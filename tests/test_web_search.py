...
from smallink.web import (
    SearchResult,
    build_provider,
    make_web_search_tool,
    provider_names,
)
from smallink.web.providers import (
    BraveProvider,
    DuckDuckGoProvider,
    TavilyProvider,
    WebSearchProvider,
...
def test_tool_returns_results():
    ...
    assert tool.__link_schema__["function"]["name"] == "web_search"
...
def test_resolve_provider_from_secretstore(tmp_path):
    from smallink.web import resolve_provider
