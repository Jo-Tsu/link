...
def test_compat_vendor_descriptors_ship_prefilled_endpoints():
    from smallink.providers.registry import get_descriptor
...
def test_compat_models_route_and_get_tool_capabilities():
    from smallink.providers.router import ProviderRouter
...
def test_matrix_labels_and_custom_model_fallback():
    from smallink.providers.matrix import MATRIX, model_labels
...
def test_reseller_descriptors_and_matrix_stay_in_lockstep():
    ...
    from smallink.providers.matrix import models_for_provider
    from smallink.providers.registry import get_descriptor
