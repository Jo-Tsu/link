...
from smallink.risk import RiskClass, classify, is_consequential
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("anything", PLAIN_META, RiskClass.EXTERNAL),
        ("anything", None, RiskClass.EXTERNAL),
    ],
)
...
def test_shell_commands_not_auto_allowed_by_default(tmp_path):
    ...
    from smallink.config import DEFAULT_ALLOWED_COMMANDS
