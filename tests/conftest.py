...
`link.testing.fake_slack` and `docs/FAKE-SLACK-SPEC.md`.
"""
...
from smallink.testing.fake_slack import FakeSlack
...
def _isolated_state_dir(tmp_path, monkeypatch):
    ...
    as burst noise in the link-connect-telemetry-events table)."""
    monkeypatch.setenv("LINK_STATE_DIR", str(tmp_path / "agent-state"))
