...
from smallink.engine import ApprovalOutcome, PermissionRequest, TurnEngine
...
def test_non_low_risk_tool_calls_stay_sequential(tmp_path):
    ...
    # Medium/ambiguous tools now fail closed in interactive mode. Auto mode lets this
    # test isolate the separate scheduling guarantee: non-low-risk calls stay sequential.
