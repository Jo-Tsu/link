...
// LIVE smoke config — runs against the REAL backend (link-server on :42871) and a REAL model.
...
export default defineConfig({
  ...
  webServer: {
    // The dev server's default API base is 127.0.0.1:42871 — i.e. the real backend (no mocks here).
