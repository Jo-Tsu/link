...
describe("PersonaView", () => {
  it("renders the persona detail (identity, tools, recommends + connect state) from the endpoint", async () => {
    ...
    expect(await screen.findByText("Ops Agent")).toBeTruthy();
    ...
    // Visible connector recommendations retain their state and actions.
    expect(screen.getByText("connected")).toBeTruthy();
    expect(screen.getByText("Connect")).toBeTruthy(); // datadog (core, not connected)
    // Configured MCP recommendations remain persisted but are not projected into this client.
