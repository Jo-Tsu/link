...
const MineMLogo = strokeLogo(
  <>
    <path d="M4.5 17.5A8.5 8.5 0 0 1 17.8 6.2" />
    <path d="M19.5 6.5A8.5 8.5 0 0 1 6.2 17.8" />
    <circle cx="18.5" cy="5.5" r="1.5" fill="currentColor" stroke="none" />
    <circle cx="5.5" cy="18.5" r="1.5" fill="currentColor" stroke="none" />
    <path d="M8 8.2c1.8-1.4 4.8-1.4 6.8.4M16 15.8c-1.8 1.4-4.8 1.4-6.8-.4" />
  </>,
);

const TraexLogo = strokeLogo(
  <>
...
export const CONNECTORS: Record<string, ConnectorRegistryEntry> = {
  ...
  minem: { label: "MineM", logo: MineMLogo },
  traex: { label: "TRAE CLI", logo: TraexLogo },
};
