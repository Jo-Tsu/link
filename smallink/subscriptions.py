...
DM/channel (request↔reply, `[link:id]`-correlated); a subscription brings a channel's messages IN
...
class ChannelBuffer:
    ...
    def __init__(self, cap: int = 50, state_path: Optional[Path] = None) -> None:
        ...
        self._names: dict[str, str] = {}  # channel address → display name ("#link-test")
