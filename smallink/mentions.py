...
When @Smallink is tagged in a channel with no subscribed session, the router spawns a
agent session that OWNS that thread and replies into it. This store is the
