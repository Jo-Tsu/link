...
Lives inside the always-on `link-server` (started/stopped in its lifespan). On inbound:
...
class Gateway:
    def __init__(
        ...
        *,
        ...
        # [link:<id>] token), it resolves the item and is consumed — not routed as a new turn.
