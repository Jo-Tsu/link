...
logger = logging.getLogger("smallink.connectors")
...
class TelegramAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        try:
            ...
            logger.warning(
                "python-telegram-bot not installed — `pip install link[messaging]`"
            )
            return False
...
class SlackAdapter(BasePlatformAdapter):
    ...
    async def connect(self) -> bool:
        try:
            ...
            logger.warning(
                "slack-bolt not installed — `pip install link[messaging]`"
            )
            return False
