...
TOOL_DEFS: tuple[ConnectorToolDef, ...] = (
    ...
    ConnectorToolDef(
        ...
        "Check MineM",
        "read",
        "Check MineM's local service and visible material counts.",
    ),
    ConnectorToolDef(
        "minem",
        "minem_search_assets",
        "Search MineM",
        "read",
        "Search MineM reports, pages, and resources.",
    ),
    ConnectorToolDef(
        "minem",
        "minem_get_asset",
        "Read MineM asset",
        "read",
        "Read one MineM report, page, or resource by reference.",
    ),
    ConnectorToolDef(
        "minem",
        ...
        "Read report pages",
        "read",
        "List the pages belonging to a MineM report.",
    ),
    ConnectorToolDef(
        "minem",
        "minem_get_versions",
        "Read asset versions",
        "read",
        "List known versions of a MineM asset.",
    ),
    ConnectorToolDef(
        "minem",
        "minem_get_lineage",
        "Read asset lineage",
        "read",
        "Read the provenance and relationships of a MineM asset.",
    ),
)
