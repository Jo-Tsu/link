...
Multiple people can run Smallink into the same channel, and every one of their
posts arrives as the same @link bot. The managed OAuth install already records WHO
