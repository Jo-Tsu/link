"""Microsoft Outlook and Calendar connector tools."""
        ...
        return acct_result(
            ...
            request_fn(
                ...
                params={
                    ...
                    "endDateTime": end
                    or (now + _dt.timedelta(days=7)).strftime(fmt),
    ...
    tools.append(
        attach(
            ...
            schema(
                ...
                {"event_id": {"type": "string"}, "account": GEN_ACCOUNT_PROP},
                ["event_id"],
            ),
            approval=True,
            caps=["outlook", "write"],
