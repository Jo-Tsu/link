...
class LocalExecutor(Executor):
    def __init__(
        ...
        *,
        ...
        self._marker = f"__LINK_DONE_{uuid.uuid4().hex}__"
...
def shell_tools(executor: Executor) -> list:
    ...
    wrapped_run.__link_schema__ = _RUN_SHELL_SCHEMA
    ...
    wrapped_output.__link_schema__ = _TASK_OUTPUT_SCHEMA
    ...
    wrapped_kill.__link_schema__ = _TASK_KILL_SCHEMA
