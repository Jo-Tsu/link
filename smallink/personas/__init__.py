"""Personas — specialized agents as declarative, skill-shaped bundles.
...
built-in surfaces (Code, Smallink, Chat, Ops) are themselves manifests — the same format third
