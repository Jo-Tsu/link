"""CLI entry point. `agent` launches the TUI; `agent code` boots the code skill."""
...
def main(argv: Optional[list[str]] = None) -> None:
    ...
    parser = argparse.ArgumentParser(
        prog="smallink", description="Smallink personal AI runtime (TUI)."
    )
    parser.add_argument(
    ...
    data_dir = state_dir()
    memory_store = SQLiteMemoryStore(data_dir / "link.db")
